    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="">Jadwal Praktek</a></li>
          <li><a class="nav-link scrollto" href="">Produk</a></li>
          <li><a class="nav-link scrollto" href="#appointment">Buat Janji</a></li>
          <li><a class="nav-link scrollto" href="#departments">Tentang Dwella</a></li>
        ...
        <div class="row gy-4">
          <div class="col-lg-3">
            <ul class="nav nav-tabs flex-column">
              <li class="nav-item">
                <a class="nav-link active show" data-bs-toggle="tab" href="#tab-1">Deskripsi</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab-2">Penghargaan</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab-3">Pengalaman Kerja</a>
              </li>
            </ul>
          </div>
          <div class="col-lg-9">
